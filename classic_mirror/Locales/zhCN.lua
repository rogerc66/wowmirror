...
L["WOWBEE_TITLE"]="魔镜";
L["WOWBEE_TOOLTIP"]="魔镜核心插件  " .. GetAddOnMetadata("WowBee", "Version");
L["WOWBEE_VERSION"]="魔镜 Ver " .. GetAddOnMetadata("WowBee", "Version");
L["WOWBEE_CONNECTION"]="魔镜连接成功！";
L["WOWBEE_DISCONNECT"]="魔镜断开连接！";
L["WOWBEE_DELAY"]="|cffffff00连接响应延时:|r|cffff0000 %.4f |r|cffffff00秒|r";
L["WOWBEE_COMERROR"]="|cffffff00注意:|r|cffff0000魔镜连接成功！响应测试失败！|cffEEAA22如不能使用，请重新打开《魔兽世界》！|r"
...
L["WOWBEE_ABOUT"]=L["WOWBEE_ABOUT"].."@|cff00ff00魔镜 |cff0055FF核心库|r |cffffff00已加载\n";
L["WOWBEE_ABOUT"]=L["WOWBEE_ABOUT"].."|cff55DD88提示:|r|cffEEAA22为保证魔镜运行正常，请确保魔镜主程序已正确连接|r\n";
L["WOWBEE_ABOUT"]=L["WOWBEE_ABOUT"].."|cff55DD88提示:|r|cffffff00通过输入|r".." |cffEE9922/Bee|r |cffffff00或使用小地图按钮来打开魔镜专用编辑器，建立属于您自己的宏脚本|r\n";
L["WOWBEE_ABOUT"]=L["WOWBEE_ABOUT"].."|cff55DD88提示:|r|cffffff00想更多了解 魔镜 - 魔兽世界自动宏插件, 请访问魔镜网站 https://zenityforce.com|r\n";
